...
def main():
    ...
    #train model
    m.fit([spec_data, serum_masks,diva_masks,tyrell_masks],[spec_data, serum_params,diva_params, tyrell_params], epochs=epochs, batch_size=batch_size, callbacks=[cp_callback])
