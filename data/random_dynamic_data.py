...
if __name__ == "__main__":
    ...
    with open('/vast/df2322/asp_data/all_data_param_random_kernels.pkl', 'rb') as handle:
...
with open("/vast/df2322/asp_data/random_dynamic_mels.pkl", 'wb') as handle:
    pickle.dump(all_mels, handle, protocol=pickle.HIGHEST_PROTOCOL)

with open("/vast/df2322/asp_data/random_dynamic_params.pkl", 'wb') as handle:
    pickle.dump(all_params, handle, protocol=pickle.HIGHEST_PROTOCOL)

with open("/vast/df2322/asp_data/random_dynamic_kernels.pkl", 'wb') as handle:
