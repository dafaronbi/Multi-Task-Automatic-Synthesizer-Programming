...
if __name__ == "__main__":
    ...
    np.save("/vast/df2322/asp_data/all_data_mels", np.array(final_out_spec))
    np.save("/vast/df2322/asp_data/all_data_serum_params", np.array(serum_out_params))
    np.save("/vast/df2322/asp_data/all_data_serum_masks", np.array(serum_mask))
    np.save("/vast/df2322/asp_data/all_data_diva_params", np.array(diva_out_params))
    np.save("/vast/df2322/asp_data/all_data_diva_masks", np.array(diva_mask))
    np.save("/vast/df2322/asp_data/all_data_tyrell_params", np.array(tyrell_out_params))
    np.save("/vast/df2322/asp_data/all_data_tyrell_masks", np.array(tyrell_mask))