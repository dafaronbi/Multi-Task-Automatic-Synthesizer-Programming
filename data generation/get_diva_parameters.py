...
engine.set_bpm(120)
synth = engine.make_plugin_processor("Diva", "Diva.vst")
count = 0
...
np.save("diva_params",np.array(all_data))
np.save("diva_preset_name", np.array(preset_name))
