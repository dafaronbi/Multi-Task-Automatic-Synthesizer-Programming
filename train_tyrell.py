...
def main():
    ...
    if not os.path.isdir("/vast/df2322/asp_data/saved_models/vst_tyrell"):
        os.makedirs("/vast/df2322/asp_data/saved_models/vst_tyrell")

    # Include the epoch in the file name (uses `str.format`)
    checkpoint_path = "/vast/df2322/asp_data/saved_models/vst_tyrell/cp-{epoch:04d}.ckpt"
