...
def main():
    ...
    if not os.path.isdir("/vast/df2322/asp_data/saved_models/vst_single_nomask"):
        os.makedirs("/vast/df2322/asp_data/saved_models/vst_single_nomask")

    # Include the epoch in the file name (uses `str.format`)
    checkpoint_path = "/vast/df2322/asp_data/saved_models/vst_single_nomask/cp-{epoch:04d}.ckpt"
    ...
    #create model
    m = model.vae_single_no_mask(64, i_dim, train_params.shape[-1], model.optimizer, warmup_it)
